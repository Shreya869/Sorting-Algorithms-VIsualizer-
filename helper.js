...
//helps in differentiating which bar is the marked, unamrked,etc.
//also how to compare the sorting algo bars and swap those
...
class Helper {
    ...
    swap = async (index1, index2) => {
        ...
        this.list[index1].style.height = `${10*value2}px`;  //dictates the size of the bar
        this.list[index2].setAttribute("value", value1);
        this.list[index2].style.height = `${10*value1}px`;   
    }
};
